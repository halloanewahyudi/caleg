...
<circle cx="84" cy="50" r="10" fill="#5ccfac">
    ...
    <animate attributeName="fill" repeatCount="indefinite" dur="1s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1" values="#5ccfac;#5ccfac;#effafc;#d4e9ed;#5ccfac" begin="0s"></animate>
</circle><circle cx="16" cy="50" r="10" fill="#5ccfac">
...
</circle><circle cx="50" cy="50" r="10" fill="#d4e9ed">
...
</circle><circle cx="84" cy="50" r="10" fill="#effafc">
